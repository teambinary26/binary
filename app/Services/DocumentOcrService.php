...
class DocumentOcrService
{
    ...
    private function expectedValue(Application $application, string $key): ?string
    {
        ...
        $value = match ($key) {
            ...
            'year_level' => $profile?->year_level ?: $answers->get('year_level') ?: $answers->get('grade_level'),
            'student_number' => $answers->get('student_number') ?: $answers->get('student_id_no') ?: $answers->get('student_id'),
